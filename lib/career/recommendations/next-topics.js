...
/**
 * @param {{ goal?: { targetRole?: string, targetLevel?: string } | null, skills?: string[], memorySkills?: string[], weaknesses?: string[], existingTopics?: string[], recommendedSkills?: string[], topSkills?: string[] }} ctx
...
export function recommendNextTopics(ctx = {}) {
  ...
  // 2. Industry-recommended skills not yet known (strong goal-independent signal).
  ...
  // 3. Top skills for the industry (slightly lower priority than recommended).
