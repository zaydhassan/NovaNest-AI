/**
 * Learning Agent (M9) — skill-gap learning plans + next-topics guidance.
 * Uses the shared specialist prompt + Gemini, grounded in the user's active
 * goal + recommended topics (passed via ctx). Registered with the Coordinator
 * so chat questions about "what should I learn" route here.
 *
 * Server-only.
 */
