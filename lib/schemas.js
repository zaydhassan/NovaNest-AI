...
export const chatSchema = z.object({
  ...
  // nullish (not optional): the client sends sessionId: null on the first
  // message of a new conversation (useCoachChat initializes it to null).
  // z.string().optional() rejects an explicit null with "Expected string,
  // received null"; .nullish() accepts both null and undefined. The route
  // treats any falsy sessionId as "create a new session".
